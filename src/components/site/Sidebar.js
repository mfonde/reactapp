...
import JSXRules from '../concepts/JSXRules.js';
import JSXvsHTML from '../concepts/JSXvsHTML.js';
import State from '../concepts/State.js';
import Effects from '../concepts/Effects.js';
import PropsDemo from '../concepts/PropsDemo.js';
    ...
    <div className = "sidebar">
        <div className = "sidebar-list-styling">
            <ul className = "sidebar-list list-unstyled">
                ...
                <li><Link to="/jsxvshtml">JSX vs HTML</Link></li>
        ...
        <div className = "sidebar-route">
            <Switch>
                ...
                <Route exact path="/jsxvshtml"><JSXvsHTML/></Route>
