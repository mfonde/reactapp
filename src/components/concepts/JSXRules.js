...
const NormalComponent = () => {
    return(
        <div style = {{border: '2px solid black'}}>
            ...
            <img src = "http://milosristic.com/wp-content/uploads/2018/08/rsz_32.png" alt="JSX and Rendering"/>
        </div>
    )
}

const CreateElementComponent = function CreateElementComponent () {
    return React.createElement(
        "div",
        {style: {border:'2px solid black'}},
        React.createElement("h1", null, "Create Element Component"),
        React.createElement("p", null, "This was constructed using successive React.createElement() calls."),
